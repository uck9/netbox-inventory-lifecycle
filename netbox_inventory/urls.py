...
urlpatterns = [
    ...
    path('assets/<int:pk>/terminate-coverage/', views.AssetTerminateCoverageView.as_view(), name='asset_terminate_coverage'),
    path('assets/bulk-add-to-program/', views.AssetBulkAddToProgramView.as_view(), name='asset_bulk_add_to_program'),
    ...
    path("vendor-programs/<int:pk>/ea-report/", views.VendorProgramEAReportView.as_view(), name="vendorprogram_ea_report"),
